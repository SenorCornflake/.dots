...
convert -size 1920x1080 tile:"$DOTFILES_BRAIN_ROOT/tmp/tiler.png" ~/wallpapers/simple-dots.png
...
convert -size 1920x1080 tile:"$DOTFILES_BRAIN_ROOT/tmp/tiler.png" ~/wallpapers/simple-thick-dots.png
rm $DOTFILES_BRAIN_ROOT/tmp/tiler.png

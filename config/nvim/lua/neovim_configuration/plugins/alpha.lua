...
dashboard.section.header.val = arts[1]
 ...
 dashboard.section.buttons.val = {
	 ...
	 dashboard.button( "n", "󰣞  Edit Neovim Config" , ":cd $DOT_ROOT/config/nvim <BAR> :Telescope find_files<CR>"),
	 dashboard.button( "d", "󰣞  Edit Dotfiles" , ":cd $DOT_ROOT <BAR> :Telescope find_files<CR>"),
